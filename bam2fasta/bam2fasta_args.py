...
def create_parser():
    ...
    parser.add_argument('--min-umi-per-barcode', default=DEFUALT_MIN_UMI_PER_BARCODE, type=int,
    ...
    parser.add_argument('--save-fastas', default="", type=str,
                        help='save merged fastas for all the unique barcodes to {CELL_BARCODE}.fasta '
    ...
    parser.add_argument('--rename-10x-barcodes', type=str,
                        help="Tab-separated file mapping 10x barcode name to new name, e.g. with channel or cell "
